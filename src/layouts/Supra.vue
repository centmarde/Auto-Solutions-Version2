<template>
  <v-row class="model-viewer-container">
    <model-viewer
      id="modelViewer"
      src="/models/toyota_supra.glb"
      ar
      ar-modes="webxr scene-viewer quick-look"
      tone-mapping="neutral"
      poster="poster.webp"
      shadow-intensity="1.4"
      camera-orbit="-300deg 80deg 4m"
      min-camera-orbit="auto auto 4.911m"
      max-camera-orbit="auto 100deg 9m"
      min-field-of-view="12deg"
      ref="modelViewer"
      :camera-controls="isCameraControlEnabled"
    >
      ...
      <button
        ...
        @click="
          zoomToHotspot('40.78414m 80.2675076114826115m 8.414183157525556m')
        "
      >
      ...
      <button
        ...
        data-visibility-attribute="visible"
        @click="
          zoomToHotspot('36.78414m 98.2675076114826115m 5.414183157525556m')
        "
      >
        <div class="hotspot-annotation"></div>
      </button>
      ...
      <button
        ...
        data-visibility-attribute="visible"
        @click="zoomToHotspot('230.6deg 78.33m -1.04m')"
      >
        <div class="hotspot-annotation"></div>
      </button>
      <button
        ...
        data-visibility-attribute="visible"
        @click="zoomToHotspot('340deg 85m 10.959285014032719m')"
      >
        <div class="hotspot-annotation"></div>
      </button>
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col">
            ...
            <ul class="dropdown-menu">
              <li>
                <router-link to="/Honda" class="dropdown-item"
                  >2024 HONDA CIVIC</router-link
                >
              </li>
              <li>
                <router-link to="/Nissan" class="dropdown-item"
                  >2024 NISSAN Z PERFORMANCE</router-link
                >
              </li>
            </ul>
          </div>
          <div
            class="spacer col me-10 d-flex justify-content-end flex-wrap flex-md-nowrap align-items-center"
          >
            <button
              class="custom-button ms-2 mt-2 mt-md-0 d-flex align-items-center"
              @click="EngineButton"
            >
              <v-icon class="me-1 my-auto">mdi-engine</v-icon> ENGINE
            </button>
            <button
              class="custom-button ms-2 mt-2 mt-md-0 d-flex align-items-center"
              @click="BodyButton"
            >
              <v-icon class="me-1 my-auto">mdi-car</v-icon> BODY
            </button>
            <button
              class="custom-button ms-2 mt-2 mt-md-0 d-flex align-items-center"
              @click="BackButton"
            >
              <v-icon class="me-1 my-auto">mdi mdi-car-back</v-icon> TRUNK
            </button>
            <button
              class="custom-button ms-2 mt-2 mt-md-0 d-flex align-items-center"
              @click="TireButton"
            >
              <v-icon class="me-1 my-auto">mdi-tire</v-icon> TIRES
            </button>
            <button
              class="custom-button ms-2 mt-2 mt-md-0 d-flex align-items-center"
              @click="InteriorButton"
            >
              <v-icon class="me-1 my-auto">mdi mdi-car-wrench</v-icon> INTERIOR
            </button>
            <button
              class="custom-button my-auto d-flex align-items-center"
            ></button>
            <button
              class="custom-button"
              @click="modalBody = true"
              style="display: none"
            >
              Open Modal
            </button>
        ...
        <div v-if="modalBody" class="modal-overlay modal-card-body">
          ...
          >
            <div class="card-body">
              <v-row>
                <v-col cols="12" md="12" class="d-flex justify-content-start">
                  <img
                    class="img-float"
                    src="http://maro-fahrzeugaufbereitung.de/wp-content/uploads/2017/01/7018555-exclusive-limited-edition-stamp.png"
                    style="width: 180px; height: 95px; top: 18px"
                    alt="Body Image"
                  />
                  <p
                    class="title-float"
            ...
            <div class="d-flex justify-content-end">
              <button
                class="custom-button me-2 mb-1"
                @click="showMoreInfoBody('CUSTOM BODY PAINT')"
              >
                More Info
              </button>
            </div>
          ...
          <div
            v-if="showColorButtons"
            class="color-buttons d-flex justify-content-around"
          >
            <button
              class="color-button"
              @click="changeColor([0.933, 0.933, 0.933, 1])"
            >
              <span
                class="color-circle"
            ...
            <button
              class="color-button"
              @click="changeColor([0.89, 0.2, 0.38, 1])"
            >
              <span
                class="color-circle"
                style="background-color: #e53461"
              ></span>
            </button>

            <button
              class="color-button"
              @click="changeColor([0.878, 0.537, 0, 1])"
            >
              <span
                class="color-circle"
            ...
            <button
              class="color-button"
              @click="changeColor([0.09, 0.09, 0.09, 1])"
            >
              <span
                class="color-circle"
            ...
            <button
              class="color-button"
              @click="changeColor([0.199, 0.01, 0.01, 0])"
            >
              <span
                class="color-circle"
                style="background-color: #730000"
              ></span>
            </button>
            ...
            <button
              ...
              @click="
                changeColor(
                  [0.25, 0.41, 0.88, 1],
                  'radial-gradient(circle, #4169e1, #8a99d9'
                )
              "
            >
              <span
        ...
        <div v-if="modalTire" class="modal-overlay modal-card-tires">
          ...
          >
            <div class="card-body">
              <v-row>
                <v-col cols="12" md="12" class="d-flex justify-content-start">
                  <img
                    class="img-float2"
                    src="../assets/supra_imgs/tire3.png"
            ...
            <div class="d-flex justify-content-end">
              <button
                class="custom-button me-2 mb-1"
                @click="showMoreInfo('Kumho Majesty 9 Solus')"
              >
                More Info
              </button>
            </div>
          ...
          >
            <div class="card-body">
              <v-row>
                <v-col cols="12" md="12" class="d-flex justify-content-start">
                  <img
                    class="img-float"
                    src="../assets/supra_imgs/tire2.png"
                    style="width: 130px"
                    alt=""
                  />
            ...
            <div class="d-flex justify-content-end">
              <button
                class="custom-button me-2 mb-1"
                @click="showMoreInfo('Hankook iON Evo')"
              >
                More Info
              </button>
            </div>
          ...
          >
            <div class="card-body">
              <v-row>
                <v-col cols="12" md="12" class="d-flex justify-content-start">
                  <img
                    class="img-float"
                    src="../assets/supra_imgs/tire1.png"
                    style="width: 145px"
                    alt=""
                  />
                  <p
            ...
            <div class="d-flex justify-content-end">
              <button
                class="custom-button me-2 mb-1"
                @click="showMoreInfo('Michelin Defender')"
              >
                More Info
              </button>
            </div>
        ...
        <div v-if="modalEngine" class="modal-overlay modal-card-engines">
          ...
          >
            <div class="card-body">
              <v-row>
                <v-col cols="12" md="12" class="d-flex justify-content-start">
                  <img
                    class="img-float"
                    src="../assets/supra_imgs/engine1.png"
                    style="width: 150px"
                    alt="Engine Image"
                  />
                  <p
            ...
            <div class="d-flex justify-content-end">
              <button
                class="custom-button me-2 mb-1"
                @click="showMoreInfoEngine('2JZ-GTE')"
              >
                More Info
              </button>
            </div>
          ...
          >
            <div class="card-body">
              <v-row>
                <v-col cols="12" md="12" class="d-flex justify-content-start">
                  <img
                    class="img-float"
                    src="../assets/supra_imgs/engine2.png"
                    style="width: 150px"
                    alt="Engine Image 2"
                  />
                  <p
            ...
            <div class="d-flex justify-content-end">
              <button
                class="custom-button me-2 mb-1"
                @click="showMoreInfoEngine('B58B30M0')"
              >
                More Info
              </button>
            </div>
          ...
          >
            <div class="card-body">
              <v-row>
                <v-col cols="12" md="12" class="d-flex justify-content-start">
                  <img
                    class="img-float"
                    src="../assets/supra_imgs/engine3.png"
                    style="width: 150px"
                    alt="Engine Image 3"
                  />
                  <p
            ...
            <div class="d-flex justify-content-end">
              <button
                class="custom-button me-2 mb-1"
                @click="showMoreInfoEngine('1JZ-GTE')"
              >
                More Info
              </button>
            </div>
        ...
        <div v-if="modalBack" class="modal-overlay modal-card-back">
          ...
          >
            <div class="card-body">
              <v-row>
                <v-col cols="12" md="12" class="d-flex justify-content-start">
                  <img
                    class="img-float"
                    src="http://extremedimensions.com/images/D/86_supraccoemhatch8.jpg"
                    alt="Back Image"
                  />
            ...
            <div class="d-flex justify-content-end">
              <button
                class="custom-button me-2 mb-1"
                @click="showMoreInfoBack('Back Model Name')"
              >
                More Info
              </button>
            </div>
          ...
          >
            <div class="card-body">
              <v-row>
                <v-col cols="12" md="12" class="d-flex justify-content-start">
                  <img
                    class="img-float"
                    src="https://files.hodoor.world/main/d548f1a5-19d0-42ce-8f94-dde69f77417b.jpg"
                    alt="Back Image 2"
                  />
                  <p class="title-float"><b>Elite Model</b></p>
            ...
            <div class="d-flex justify-content-end">
              <button
                class="custom-button me-2 mb-1"
                @click="showMoreInfoBack('Another Back Model')"
              >
                More Info
              </button>
            </div>
          ...
          >
            <div class="card-body">
              <v-row>
                <v-col cols="12" md="12" class="d-flex justify-content-start">
                  <img
                    class="img-float"
                    src="https://1fastsupra.com/cdn/shop/products/20TYSPTRRS_3_1200x1200.png?v=1665369453"
                    alt="Back Image 3"
                  />
                  <p class="title-float"><b>Exclusive Back </b></p>
            ...
            <div class="d-flex justify-content-end">
              <button
                class="custom-button me-2 mb-1"
                @click="showMoreInfoBack('Premium Back Model')"
              >
                More Info
              </button>
            </div>
        ...
        <div v-if="modalInterior" class="modal-overlay modal-card-interior">
          ...
          >
            <div class="card-body">
              <v-row>
                <v-col cols="12" md="12" class="d-flex justify-content-start">
                  <img
                    class="img-float"
                    src="https://www.supercars.net/blog/wp-content/uploads/2019/01/2020-toyota-supra-gr-interior-01.jpeg"
                    alt="Interior Image"
                  />
                  <p class="title-float"><b>Ultimate Model </b></p>
            ...
            <div class="d-flex justify-content-end">
              <button
                class="custom-button me-2 mb-1"
                @click="showMoreInfoInterior('Interior Model Name')"
              >
                More Info
              </button>
            </div>
          ...
          >
            <div class="card-body">
              <v-row>
                <v-col cols="12" md="12" class="d-flex justify-content-start">
                  <img
                    class="img-float"
                    src="https://www.hdcarwallpapers.com/download/toyota_gr_supra_2l_2020_interior_5k-3840x2160.jpg"
            ...
            <div class="d-flex justify-content-end">
              <button
                class="custom-button me-2 mb-1"
                @click="showMoreInfoInterior('Another Interior Model')"
              >
                More Info
              </button>
            </div>
          ...
          >
            <div class="card-body">
              <v-row>
                <v-col cols="12" md="12" class="d-flex justify-content-start">
                  <img
                    class="img-float"
                    src="https://static1.hotcarsimages.com/wordpress/wp-content/uploads/2022/06/2023-Toyota-Supras-Interior.jpg"
            ...
            <div class="d-flex justify-content-end">
              <button
                class="custom-button me-2 mb-1"
                @click="showMoreInfoInterior('Premium Interior Model')"
              >
                More Info
              </button>
            </div>
        ...
        <v-dialog v-model="moreInfoModalInterior" max-width="400">
          <v-card>
            ...
            <v-card-actions>
              <v-btn color="primary" @click="closeMoreInfoInterior"
                >Close</v-btn
              >
            </v-card-actions>
          </v-card>
  ...
  methods: {
    ...
    changeColor(colorArray) {
      ...
      const confirmation = window.confirm(
        `Are you sure you want to choose this color?`
      );
      if (confirmation) {
    ...
    showMoreInfoInterior(interiorName) {
      ...
      if (interiorName === "Interior Model Name") {
        ...
        this.moreInfoInterior = {
          ...
          details:
            "An upscale interior with advanced features for luxury driving.",
        };
      }
    ...
    showMoreInfo(tireName) {
      ...
      if (tireName === "Kumho Majesty 9 Solus") {
        this.moreInfo = {
          ...
          loadIndex: "91",
          details:
            "This is a high-performance tire suitable for wet and dry conditions.",
