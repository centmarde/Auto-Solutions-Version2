<template>
  ...
  >
    <div class="container-fluid">
      ...
      >
        <div
          class="ms-auto d-flex flex-column flex-lg-row align-items-center justify-content-end w-100"
        >
          <ul class="navbar-nav text-center">
            <li class="nav-item">
              <router-link
                to="/Home"
                class="nav-link btn wes"
                @click="closeMenu"
                >HOME</router-link
              >
            </li>
            ...
            <li class="nav-item">
              <router-link
                ...
                class="nav-link btn wes"
                @click="closeMenu"
                >INQUIRES</router-link
              >
            </li>

            <li class="nav-item">
              <router-link to="/" class="nav-link btn wes" @click="handleLogout"
                >LOGOUT</router-link
              >
            </li>
