<template>
    <div class="model-viewer-container2">
        <model-viewer id="carmodel" src="/models/honda.glb" ar ar-modes="webxr scene-viewer quick-look" tone-mapping="neutral"
            poster="poster.webp" shadow-intensity="1.4" camera-orbit="265deg 90deg 18m"
            ...
            <button id="interior" class="hotspot" slot="hotspot-4"
                ...
                data-visibility-attribute="visible" @click="zoomToHotspot('46.6deg 65.33m 20.04m')">
                <div class="hotspot-annotation"></div>
            </button>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col mt-3 d-flex me-10 justify-content-end">
