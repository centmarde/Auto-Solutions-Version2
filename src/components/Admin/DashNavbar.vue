<template>
  ...
  >
    <div class="container-fluid">
      ...
      >
        <div
          class="ms-auto d-flex align-items-center justify-content-end w-100"
        >
          <ul class="navbar-nav text-center w-100">
            <li class="nav-item border-top">
              <router-link
                to="/Admin"
                class="nav-link btn fs-6 p-2 d-md-none d-block"
            ...
            <li class="nav-item">
              <router-link
                to="/Home"
                class="nav-link btn p-2 fs-6 d-md-none d-block"
                >View As Client</router-link
              >
            </li>
            <li class="nav-item">
              <router-link
            ...
            <li class="nav-item">
              <router-link
                to="/Clients"
                class="nav-link btn fs-6 p-2 d-md-none d-block"
                >Client members</router-link
              >
            </li>
            <li class="nav-item">
              <router-link
                to="/"
                class="nav-link btn wes fs-6 p-2 d-md-none d-block"
                @click="handleLogout"
                >LOGOUT</router-link
              >
            </li>
